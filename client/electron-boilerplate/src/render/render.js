...
export class Renderer {
    ...
    onRenderUpdate() {        
        ...
        const cellWidth = cellBoxWidth -  this.borderWidth
        const cellHeight = cellBoxHeight  - this.borderWidth
        const drawCellBorder = (ctx, i, j) => {
            const rect = {x:i*cellBoxWidth, y:j*cellBoxHeight,width:cellBoxWidth,height:cellBoxHeight}
